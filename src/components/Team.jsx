...
const OurTeam = () => {
  return (
    <div className="min-h-screen dark:bg-slate-800 flex flex-wrap justify-center gap-6 py-10">
      {teamMembers.map((member, index) => (
        <div
          key={index}
          className="bg-gray-100 dark:bg-gray-700 relative shadow-xl overflow-hidden hover:shadow-2xl group rounded-xl p-5 transition-all duration-500 transform w-80"
        >
