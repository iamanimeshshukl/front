...
const Hero = () => {
  return (
    <section className="relative w-full min-h-screen flex flex-col lg:flex-row items-center justify-between overflow-hidden p-4 sm:p-6 lg:p-14 bg-gradient-to-br from-slate-50 via-white to-blue-50">
      ...
      <div className="flex-1 z-10 flex flex-col justify-center items-center lg:items-start space-y-6 sm:space-y-8 lg:space-y-10 max-w-2xl px-2 sm:px-4 lg:px-0 mt-4 sm:mt-6 lg:mt-0">
        ...
        <div className="flex items-center justify-center lg:justify-start space-x-4 sm:space-x-6 mt-6 sm:mt-8">
          ...
          <div className="flex space-x-3 sm:space-x-4">
            {/* Instagram */}
            <a
              href="https://instagram.com/zenher"
              target="_blank"
              rel="noopener noreferrer"
            ...
            {/* TikTok */}
            <a
              href="https://tiktok.com/@zenher"
              target="_blank"
              rel="noopener noreferrer"
              className="group p-2 sm:p-3 bg-white/80 backdrop-blur-sm rounded-xl border border-slate-200 hover:border-slate-300 transition-all duration-300 hover:scale-110 hover:shadow-lg"
            >
              <svg className="w-5 h-5 sm:w-6 sm:h-6 text-slate-600 group-hover:text-black transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
